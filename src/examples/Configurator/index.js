...
function Configurator() {
  ...
  return (
    <ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator }}>
      ...
      >
        <SoftBox>
          <SoftTypography variant="h5">E-Keyboard Configurator</SoftTypography>
      ...
      <SoftBox pt={1.25} pb={3} px={3}>
        ...
        <Divider />
        <SoftTypography variant="h1">Welcome to</SoftTypography>
        <SoftTypography variant="h3">E-Keyboard</SoftTypography>
      </SoftBox>
    </ConfiguratorRoot>
  );
}
