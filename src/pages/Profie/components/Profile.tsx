      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180 my-8">
              <form className="flex flex-col items-center  space-y-6">
                <div className="nameFiled flex gap-3 items-center">
                ...
                <Link
                  to="#"
                  className="inline-flex items-center justify-center rounded-md bg-primary py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-20 "
                >
                  Save Changes
                </Link>
              </form>
