...
const UpdateProductModal = ({ selectedProduct }: UpdateProductModal) => {
  ...
  const { isLoading, isUpdateModalOpen } = useSelector(
  ...
  const handleUpdateProduct = async (e: React.ChangeEvent<HTMLFormElement>) => {
    e.preventDefault();

    const updateProductData: UpdateProductDT = {
      newProduct,
      selectedImage,
      selectedProduct,
    };
